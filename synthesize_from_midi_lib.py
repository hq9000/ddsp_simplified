...
from ddsp_simplified.feature_names import MIDI_FEATURE_VELOCITY, MIDI_FEATURE_PITCH, MIDI_FEATURE_NOTE_SEQUENCE_NUMBER
...
def synthesize_audio_by_midi(
    ...
    midi_feature_names = get_midi_feature_names_augmented_with_pitch_velocity_sequence_number(
        midi_feature_names
    )
...
def get_midi_feature_names_augmented_with_pitch_velocity_sequence_number(midi_feature_names: List[str]) -> List[str]:
    ...
    midi_feature_names.append(MIDI_FEATURE_NOTE_SEQUENCE_NUMBER)
